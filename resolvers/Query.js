...
module.exports = {
  totalStudents: (_, __, { studentData }) =>
    studentData.estimatedDocumentCount(),
  ...
  async numberOfStudentsInCourse(_, { period }, { studentData }) {
    const studentsInCourse = await studentData.countDocuments({
      period: period
    })
  ...
  async findClassPeriodByTestDueDate(
    _,
    { dueDate, period },
    { classPeriodData }
  ) {
